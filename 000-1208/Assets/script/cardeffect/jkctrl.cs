...
public class jkctrl : MonoBehaviour {
	...
	void Update () {
		...
		if (inin) {
					...
					GameObject.Find("highboom(Clone)").transform.localPosition= new Vector3 (-7684,913, 0);
					...
					GameObject.Find("lowboom(Clone)").transform.localPosition= new Vector3 (-7684,913, 0);
